          ...
          <div className="mt-4 p-4 border rounded text-contrast">
            <ul>
              <li className="mb-2">
                ...
                <span>{directionsData.routes[0].legs[0].start_address}</span>
              </li>

              <li className="mb-2">
                <strong>Destino:</strong>{' '}
                <span>{directionsData.routes[0].legs[0].end_address}</span>
              </li>

              <li className="mb-2">
                <strong>Distância:</strong>{' '}
                <span>{directionsData.routes[0].legs[0].distance.text}</span>
              </li>

              <li className="mb-2">
                <strong>Duração:</strong>{' '}
                <span>{directionsData.routes[0].legs[0].duration.text}</span>
              </li>
            </ul>
            ...
            <NewRouteForm>
              ...
              <button
                type="submit"
                className="bg-main text-primary font-bold p-2 rounded mt-4 hover:bg-main/85 transition-colors duration-200"
              >
                Adicionar rota
              </button>
            </NewRouteForm>
